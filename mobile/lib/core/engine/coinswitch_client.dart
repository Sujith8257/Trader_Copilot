...
class CoinSwitchClient {
  ...
  /// Min/max order value + precision for a symbol, straight from the
  ...
  Future<
    ...
    final body = await _request('GET', '/trade/api/v2/tradeInfo',
        ...
        params: {'exchange': exchange, 'symbol': '$symbol/INR'});

    final exchangeData = (body['data'] as Map<String, dynamic>? ?? {})[exchange]
