...
Future<void> showOrderTicket(BuildContext context, WidgetRef ref,
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        ...
        backgroundColor:
            result.executed ? null : TC.loss.withValues(alpha: 0.9),
      ));
    } catch (e) {
      setState(() => _error = '$e');
    } finally {
          ...
          child: Column(
            ...
            children: [
              Row(children: [
                ...
                if (_livePrice != null)
                  Chip(
                    ...
                    label: Text(formatINR(_livePrice!),
              ...
              TextField(
                ...
                decoration: const InputDecoration(hintText: 'Quantity (e.g. 0.01)'),
              ),
              if (_isLimit) ...[
                const SizedBox(height: 8),
                TextField(
                  ...
                  keyboardType:
                      const TextInputType.numberWithOptions(decimal: true),
                  decoration:
                      const InputDecoration(hintText: 'Limit price in ₹'),
                ),
              ],
              if (_error != null) ...[
                const SizedBox(height: 8),
